...
// --- Assessment configuration (เหมือนเดิม) ---
const assessments = [
  {
    id: "ham-d",
      ...
      <div className="max-w-4xl mx-auto px-6 py-6">
        <div className="mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">
            แบบประเมินที่มีให้บริการ
          </h2>
          <p className="text-gray-600">
            กรุณาเลือกแบบประเมินที่ต้องการทำการวินิจฉัย
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {assessments.map((assessment) => (
            <Link
              key={assessment.id}
              href={`/pages/papers/${assessment.id}${
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3
                      className={`font-semibold text-lg ${assessment.textColor} group-hover:underline`}
                    >
                      {assessment.title}
                    </h3>
                    <span
                      className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${assessment.badgeColor} mt-1`}
                    >
                      {assessment.category}
                    </span>
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                เลือกแบบประเมินทางการแพทย์ที่เหมาะสม
              </p>
            </div>
